...
$ftp_folder = '/home/farnaz/public_html/uploads'; 
$log_file = "/home/farnaz/public_html/gallery/gallery_log.txt";
...
if (!empty($new_files)) {
    foreach ($new_files as $file) {
        ...
        $file_url = "http://farnazboroumand.ir/uploads/" . urlencode($file);
